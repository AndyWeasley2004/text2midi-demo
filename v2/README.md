# Conditional samples — `midi_gen_weak_sft_v2/final`
...
CUDA_VISIBLE_DEVICES=4 python -m inference.weak_sft_cond.generate_demo \
  ...
  --output-dir demos/weak_sft_v2_cond
```
...
temperature 0.95, top_p 0.98, top_k 0, `max_new_tokens 4094`, `MidiGrammar`
...
LD_PRELOAD=/lib/x86_64-linux-gnu/libffi.so.7 OMP_NUM_THREADS=8 \
  python demos/weak_sft_v2_cond/build.py
```
